...
function chkQState(id)
  QSTATE(id, -1)
  if (qData[1023].state ~= 2 or qData[1024].state ~= 2 or qData[1033].state ~= 2 or qData[1034].state ~= 2) and GET_PLAYER_JOB1() == 1 and (__QUEST_HAS_ALL_ITEMS(qt[1023].goal.getItem) or CHECK_ITEM_CNT(qt[1024].goal.getItem[1].id) >= qt[1024].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1033].goal.getItem[1].id) >= qt[1033].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1034].goal.getItem[1].id) >= qt[1034].goal.getItem[1].count) then
    if qData[1023].state == 1 or qData[1024].state == 1 or qData[1033].state == 1 or qData[1034].state == 1 then
      if __QUEST_HAS_ALL_ITEMS(qt[1023].goal.getItem) or CHECK_ITEM_CNT(qt[1024].goal.getItem[1].id) >= qt[1024].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1033].goal.getItem[1].id) >= qt[1033].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1034].goal.getItem[1].id) >= qt[1034].goal.getItem[1].count then
        QSTATE(id, 2)
      else
        QSTATE(id, 1)
      end
  ...
  if (qData[1025].state ~= 2 or qData[1026].state ~= 2 or qData[1035].state ~= 2 or qData[1036].state ~= 2) and GET_PLAYER_JOB1() == 2 and (__QUEST_HAS_ALL_ITEMS(qt[1025].goal.getItem) or CHECK_ITEM_CNT(qt[1026].goal.getItem[1].id) >= qt[1026].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1035].goal.getItem[1].id) >= qt[1035].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1036].goal.getItem[1].id) >= qt[1036].goal.getItem[1].count) then
    if qData[1025].state == 1 or qData[1026].state == 1 or qData[1035].state == 1 or qData[1036].state == 1 then
      if __QUEST_HAS_ALL_ITEMS(qt[1025].goal.getItem) or CHECK_ITEM_CNT(qt[1026].goal.getItem[1].id) >= qt[1026].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1035].goal.getItem[1].id) >= qt[1035].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1036].goal.getItem[1].id) >= qt[1036].goal.getItem[1].count then
        QSTATE(id, 2)
      else
        QSTATE(id, 1)
      end
  ...
  if (qData[1027].state ~= 2 or qData[1028].state ~= 2 or qData[1037].state ~= 2 or qData[1038].state ~= 2) and GET_PLAYER_JOB1() == 3 and (__QUEST_HAS_ALL_ITEMS(qt[1027].goal.getItem) or CHECK_ITEM_CNT(qt[1028].goal.getItem[1].id) >= qt[1028].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1037].goal.getItem[1].id) >= qt[1037].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1038].goal.getItem[1].id) >= qt[1038].goal.getItem[1].count) then
    if qData[1027].state == 1 or qData[1028].state == 1 or qData[1037].state == 1 or qData[1038].state == 1 then
      if __QUEST_HAS_ALL_ITEMS(qt[1027].goal.getItem) or CHECK_ITEM_CNT(qt[1028].goal.getItem[1].id) >= qt[1028].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1037].goal.getItem[1].id) >= qt[1037].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1038].goal.getItem[1].id) >= qt[1038].goal.getItem[1].count then
        QSTATE(id, 2)
      else
        QSTATE(id, 1)
      end
  ...
  if (qData[1029].state ~= 2 or qData[1030].state ~= 2 or qData[1039].state ~= 2 or qData[1040].state ~= 2) and GET_PLAYER_JOB1() == 4 and (__QUEST_HAS_ALL_ITEMS(qt[1029].goal.getItem) or CHECK_ITEM_CNT(qt[1030].goal.getItem[1].id) >= qt[1030].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1039].goal.getItem[1].id) >= qt[1039].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1040].goal.getItem[1].id) >= qt[1040].goal.getItem[1].count) then
    if qData[1029].state == 1 or qData[1030].state == 1 or qData[1039].state == 1 or qData[1040].state == 1 then
      if __QUEST_HAS_ALL_ITEMS(qt[1029].goal.getItem) or CHECK_ITEM_CNT(qt[1030].goal.getItem[1].id) >= qt[1030].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1039].goal.getItem[1].id) >= qt[1039].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1040].goal.getItem[1].id) >= qt[1040].goal.getItem[1].count then
        QSTATE(id, 2)
      else
        QSTATE(id, 1)
      end
  ...
  if (qData[1031].state ~= 2 or qData[1032].state ~= 2 or qData[1041].state ~= 2 or qData[1042].state ~= 2) and GET_PLAYER_JOB1() == 5 and (__QUEST_HAS_ALL_ITEMS(qt[1031].goal.getItem) or CHECK_ITEM_CNT(qt[1032].goal.getItem[1].id) >= qt[1032].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1041].goal.getItem[1].id) >= qt[1041].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1042].goal.getItem[1].id) >= qt[1042].goal.getItem[1].count) then
    if qData[1031].state == 1 or qData[1032].state == 1 or qData[1041].state == 1 or qData[1042].state == 1 then
      if __QUEST_HAS_ALL_ITEMS(qt[1031].goal.getItem) or CHECK_ITEM_CNT(qt[1032].goal.getItem[1].id) >= qt[1032].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1041].goal.getItem[1].id) >= qt[1041].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1042].goal.getItem[1].id) >= qt[1042].goal.getItem[1].count then
        QSTATE(id, 2)
      else
        QSTATE(id, 1)
      end
