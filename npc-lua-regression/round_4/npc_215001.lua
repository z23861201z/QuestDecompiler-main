...
function chkQState(id)
  QSTATE(id, -1)
  if (qData[1023].state ~= 2 or qData[1024].state ~= 2 or qData[1033].state ~= 2 or qData[1034].state ~= 2) and GET_PLAYER_JOB1() == 1 and (__QUEST_HAS_ALL_ITEMS(qt[1023].goal.getItem) or __QUEST_HAS_ALL_ITEMS(qt[1024].goal.getItem) or CHECK_ITEM_CNT(qt[1033].goal.getItem[1].id) >= qt[1033].goal.getItem[1].count or CHECK_ITEM_CNT(qt[1034].goal.getItem[1].id) >= qt[1034].goal.getItem[1].count) then
