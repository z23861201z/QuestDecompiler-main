...
function chkQState(id)
  ...
  if qData[2791].state == 1 and CHECK_ITEM_CNT(qt[2791].goal.getItem[1].id) >= qt[2791].goal.getItem[1].count and __QUEST_HAS_ALL_KILL_TARGETS(qt[2791].goal.killMonster) then
    QSTATE(id, 2)
  end
