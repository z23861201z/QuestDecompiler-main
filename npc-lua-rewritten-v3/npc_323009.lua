...
function npcsay(id)
  ...
  if qData[874].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[874].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[874].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[874].goal.getItem) then
  ...
  if qData[875].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[875].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[875].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[875].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
        NPC_SAY("辛苦了。这是{0xFFFFFF00}近卫兵可心{END}送来的奖励。那明天见吧！")
  ...
  if qData[2859].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2859].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2859].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2859].goal.getItem) then
      NPC_SAY("哇！这就是新的酒！~")
