...
function npcsay(id)
  ...
  if qData[118].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[118].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[118].goal.getItem) then
  ...
  if qData[119].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[119].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[119].goal.getItem) then
      NPC_SAY("你的义举为我们正派树立了形象。按照约定，我来教你{0xFFFFFF00}[ 飞龙掌 ]{END}。")
  ...
  if qData[120].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[120].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[120].goal.getItem) then
      NPC_SAY("你的义举为我们正派树立了形象。按照约定，我来教你{0xFFFFFF00}[ 飞龙掌 ]{END}。")
  ...
  if qData[381].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[381].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[381].goal.getItem) then
      NPC_SAY("你的义举为我们正派树立了形象。按照约定，我来教你{0xFFFFFF00}[ 飞龙掌 ]{END}。")
  ...
  if qData[627].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[627].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[627].goal.getItem) then
      NPC_SAY("你的义举为我们正派树立了形象。按照约定，我来教你{0xFFFFFF00}[ 飞龙掌 ]{END}。")
  ...
  if qData[2083].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2083].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2083].goal.getItem) then
      NPC_SAY("你的义举为我们正派树立了形象。按照约定，我来教你{0xFFFFFF00}[ 飞龙掌 ]{END}。")
