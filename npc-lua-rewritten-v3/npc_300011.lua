...
function npcsay(id)
  ...
  if qData[133].state == 1 and __QUEST_HAS_ALL_ITEMS(qt[133].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[133].goal.getItem) then
  ...
  if qData[134].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[134].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[134].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
  ...
  if qData[1207].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[1207].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[1207].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
  ...
  if qData[2066].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2066].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2066].goal.getItem) then
