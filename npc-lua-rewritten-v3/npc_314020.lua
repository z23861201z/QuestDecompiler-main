...
function npcsay(id)
  ...
  if qData[123].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[123].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[123].goal.getItem) then
  ...
  if qData[124].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[124].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[124].goal.getItem) then
      NPC_SAY("你很好的掌控了弱者内心的愤怒。按照约定，我来教你飞龙掌。")
  ...
  if qData[125].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[125].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[125].goal.getItem) then
      NPC_SAY("你很好的掌控了弱者内心的愤怒。按照约定，我来教你飞龙掌。")
  ...
  if qData[382].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[382].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[382].goal.getItem) then
      NPC_SAY("你很好的掌控了弱者内心的愤怒。按照约定，我来教你飞龙掌。")
  ...
  if qData[631].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[631].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[631].goal.getItem) then
      NPC_SAY("你很好的掌控了弱者内心的愤怒。按照约定，我来教你飞龙掌。")
  ...
  if qData[2087].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2087].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2087].goal.getItem) then
