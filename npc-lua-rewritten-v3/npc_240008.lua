...
function npcsay(id)
  ...
  if qData[3699].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[3699].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[3699].goal.getItem) then
  ...
  if qData[3700].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[3700].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[3700].goal.getItem) then
