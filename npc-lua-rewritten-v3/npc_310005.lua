...
function npcsay(id)
  ...
  if qData[246].state == 1 then
    if qData[246].meetNpc[1] ~= id then
      ...
      return
    elseif __QUEST_HAS_ALL_ITEMS(qt[246].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[246].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[246].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[246].goal.getItem) then
  ...
  if qData[465].state == 1 and qData[464].state == 2 then
    if __QUEST_HAS_ALL_ITEMS(qt[465].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[465].goal.getItem) then
      NPC_QSAY(465, 3)
