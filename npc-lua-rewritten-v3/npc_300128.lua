...
function npcsay(id)
  ...
  if qData[2012].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2012].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2012].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2012].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2012].goal.getItem) then
  ...
  if qData[2013].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2013].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2013].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(4) then
