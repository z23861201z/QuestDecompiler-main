...
function npcsay(id)
  ...
  if qData[1141].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[1141].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[1141].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[1141].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[1141].goal.getItem) then
