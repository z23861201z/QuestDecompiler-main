...
function npcsay(id)
  ...
  if qData[2329].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2329].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2329].goal.getItem) then
  ...
  if qData[2738].state == 1 and __QUEST_HAS_ALL_ITEMS(qt[2738].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2738].goal.getItem) then
  ...
  if qData[2803].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2803].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2803].goal.getItem) then
  ...
  if qData[2804].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2804].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2804].goal.getItem) then
  ...
  if qData[2805].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2805].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2805].goal.getItem) then
  ...
  if qData[3742].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[3742].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[3742].goal.getItem) then
...
function chkQState(id)
  ...
  if qData[2738].state ~= 2 and qData[2737].state == 2 and GET_PLAYER_LEVEL() >= qt[2738].needLevel then
    if qData[2738].state == 1 then
      if __QUEST_HAS_ALL_ITEMS(qt[2738].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2738].goal.getItem) then
        QSTATE(id, 2)
      else
        QSTATE(id, 1)
      end
