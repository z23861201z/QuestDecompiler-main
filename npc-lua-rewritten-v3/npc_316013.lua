...
function npcsay(id)
  ...
  if qData[2423].state == 1 and __QUEST_HAS_ALL_ITEMS(qt[2423].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2423].goal.getItem) then
    if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[2425].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2425].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2425].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[2452].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2452].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2452].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2452].goal.getItem) then
  ...
  if qData[2453].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2453].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2453].goal.getItem) then
  ...
  if qData[2454].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2454].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2454].goal.getItem) then
