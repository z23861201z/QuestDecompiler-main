...
function npcsay(id)
  ...
  if qData[1558].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1558].goal.getItem) and __QUEST_CHECK_ITEMS(qt[1558].goal.getItem) then
  ...
  if qData[1546].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1546].goal.getItem) then
  ...
  if qData[480].state == 2 and qData[481].state == 1 and __QUEST_CHECK_ITEMS(qt[481].goal.getItem) then
