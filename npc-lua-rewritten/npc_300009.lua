...
function npcsay(id)
  ...
  if qData[248].state == 1 and qData[247].state == 2 and __QUEST_CHECK_ITEMS(qt[248].goal.getItem) then
  ...
  if qData[460].state == 1 and qData[459].state == 2 then
    if __QUEST_CHECK_ITEMS(qt[460].goal.getItem) then
      NPC_QSAY(460, 3)
  ...
  if qData[1346].state == 1 and __QUEST_CHECK_ITEMS(qt[1346].goal.getItem) then
...
function chkQState(id)
  ...
  if qData[248].state == 1 and qData[247].state == 2 and GET_PLAYER_LEVEL() >= qt[248].needLevel and __QUEST_CHECK_ITEMS(qt[248].goal.getItem) then
    QSTATE(id, 2)
  end
