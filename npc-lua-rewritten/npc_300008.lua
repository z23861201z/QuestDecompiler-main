...
function npcsay(id)
  ...
  if qData[718].state == 1 and __QUEST_CHECK_ITEMS(qt[718].goal.getItem) then
    NPC_SAY("Äã»¹»ØÀ´£¿ÓÂÆø¿É¼Î°¡¡£ÄãÐ¡×ÓËµÒªÖ¤Ã÷µÄ¾ÍÊÇÕâ¸öÂð£¿")
    SET_QUEST_STATE(718, 2)
  end
  if qData[719].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[719].goal.getItem) then
  ...
  if qData[724].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[724].goal.getItem) and __QUEST_CHECK_ITEMS(qt[724].goal.getItem) and __QUEST_CHECK_ITEMS(qt[724].goal.getItem) then
  ...
  if qData[2190].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2190].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2190].goal.getItem) then
  ...
  if qData[2197].state == 1 and __QUEST_CHECK_ITEMS(qt[2197].goal.getItem) then
  ...
  if qData[2208].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2208].goal.getItem) then
  ...
  if qData[2210].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2210].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2210].goal.getItem) then
  ...
  if qData[2211].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2211].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2211].goal.getItem) then
  ...
  if qData[2212].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2212].goal.getItem) then
  ...
  if qData[2213].state == 1 then
    if qData[2213].killMonster[qt[2213].goal.killMonster[1].id] >= qt[2213].goal.killMonster[1].count and __QUEST_CHECK_ITEMS(qt[2213].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2213].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2213].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2213].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2213].goal.getItem) then
  ...
  if qData[2324].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2324].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2324].goal.getItem) then
