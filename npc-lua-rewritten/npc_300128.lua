...
function npcsay(id)
  ...
  if qData[2012].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2012].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2012].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2012].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2012].goal.getItem) then
  ...
  if qData[2013].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2013].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2013].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(4) then
  ...
  if qData[2014].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2014].goal.getItem) then
