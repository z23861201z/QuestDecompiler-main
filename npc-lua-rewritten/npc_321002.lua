...
function npcsay(id)
  ...
  if qData[3656].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[3656].goal.getItem) and __QUEST_CHECK_ITEMS(qt[3656].goal.getItem) and __QUEST_CHECK_ITEMS(qt[3656].goal.getItem) and __QUEST_CHECK_ITEMS(qt[3656].goal.getItem) then
