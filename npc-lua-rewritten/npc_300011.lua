...
function npcsay(id)
  ...
  clickNPCid = id
  if qData[91].state == 1 and __QUEST_CHECK_ITEMS(qt[91].goal.getItem) then
  ...
  if qData[133].state == 1 and __QUEST_CHECK_ITEMS(qt[133].goal.getItem) and __QUEST_CHECK_ITEMS(qt[133].goal.getItem) then
  ...
  if qData[134].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[134].goal.getItem) and __QUEST_CHECK_ITEMS(qt[134].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
  ...
  if qData[135].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[135].goal.getItem) and SET_ITEM_PERCENT(8510061) >= 371 then
      if 1 <= CHECK_INVENTORY_CNT(2) then
  ...
  if qData[1005].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1005].goal.getItem) then
  ...
  if qData[1207].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1207].goal.getItem) and __QUEST_CHECK_ITEMS(qt[1207].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
  ...
  if qData[1210].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1210].goal.getItem) then
  ...
  if qData[2066].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2066].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2066].goal.getItem) then
  ...
  if qData[2067].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2067].goal.getItem) then
  ...
  if qData[2068].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2068].goal.getItem) then
  ...
  if qData[2898].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2898].goal.getItem) then
...
function chkQState(id)
  ...
  if qData[91].state == 1 and GET_PLAYER_LEVEL() >= qt[91].needLevel then
    if __QUEST_CHECK_ITEMS(qt[91].goal.getItem) then
      QSTATE(id, 2)
    else
      QSTATE(id, 1)
    end
