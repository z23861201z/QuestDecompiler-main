...
function npcsay(id)
  ...
  if qData[2744].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2744].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2744].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2744].goal.getItem) then
  ...
  if qData[2789].state == 1 and __QUEST_CHECK_ITEMS(qt[2789].goal.getItem) then
