...
function npcsay(id)
  ...
  if qData[132].state == 1 then
    if qData[132].meetNpc[1] ~= id then
      ...
      NPC_QSAY(132, 1)
      return
    elseif __QUEST_CHECK_ITEMS(qt[132].goal.getItem) and __QUEST_CHECK_ITEMS(qt[132].goal.getItem) and __QUEST_CHECK_ITEMS(qt[132].goal.getItem) then
  ...
  if qData[429].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[429].goal.getItem) and __QUEST_CHECK_ITEMS(qt[429].goal.getItem) then
  ...
  if qData[430].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[430].goal.getItem) and __QUEST_CHECK_ITEMS(qt[430].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(1) then
        NPC_SAY("?????. ?????. ? ???? ?? ???.")
  ...
  if qData[431].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[431].goal.getItem) and __QUEST_CHECK_ITEMS(qt[431].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(1) then
        NPC_SAY("?????. ?????. ? ???? ?? ???.")
  ...
  if qData[432].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[432].goal.getItem) and __QUEST_CHECK_ITEMS(qt[432].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(1) then
        NPC_SAY("?????. ?????. ? ???? ?? ???.")
  ...
  if qData[687].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[687].goal.getItem) and __QUEST_CHECK_ITEMS(qt[687].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(1) then
        NPC_SAY("?????. ?????. ? ???? ?? ???.")
  ...
  if qData[437].state == 1 and __QUEST_CHECK_ITEMS(qt[437].goal.getItem) then
    NPC_SAY(" ?? ??? ??? ? ??? ???? ??? ?? ?????? ?? ?????.")
    SET_QUEST_STATE(437, 2)
    return
  end
  if qData[447].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[447].goal.getItem) and __QUEST_CHECK_ITEMS(qt[447].goal.getItem) and __QUEST_CHECK_ITEMS(qt[447].goal.getItem) then
  ...
  if qData[1151].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1151].goal.getItem) then
  ...
  if qData[1185].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1185].goal.getItem) then
  ...
  if qData[1186].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1186].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
