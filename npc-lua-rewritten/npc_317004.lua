...
function npcsay(id)
  ...
  if qData[1138].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1138].goal.getItem) then
  ...
  if qData[1160].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1160].goal.getItem) then
  ...
  if qData[1166].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1166].goal.getItem) then
      NPC_SAY("谢谢。料理做好了就叫你。")
  ...
  if qData[1173].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1173].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1175].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1175].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
