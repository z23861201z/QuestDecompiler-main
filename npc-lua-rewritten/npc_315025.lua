...
function npcsay(id)
  ...
  if qData[1348].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1348].goal.getItem) then
      NPC_SAY("比想象的要快啊。辛苦了。")
  ...
  if qData[1349].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1349].goal.getItem) then
  ...
  if qData[1350].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1350].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1351].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1351].goal.getItem) then
  ...
  if qData[1352].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1352].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1353].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1353].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1354].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1354].goal.getItem) and __QUEST_CHECK_ITEMS(qt[1354].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1355].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1355].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1356].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1356].goal.getItem) then
      NPC_SAY("好！成功了！")
  ...
  if qData[1358].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1358].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1359].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1359].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1360].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1360].goal.getItem) then
  ...
  if qData[1362].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1362].goal.getItem) then
  ...
  if qData[1363].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1363].goal.getItem) then
  ...
  if qData[1364].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1364].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(1) then
  ...
  if qData[1365].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1365].goal.getItem) then
  ...
  if qData[1366].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1366].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
        NPC_SAY("辛苦了。施主。但那是！")
  ...
  if qData[1368].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1368].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1369].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1369].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1370].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1370].goal.getItem) then
      NPC_SAY("千万要去到好的地方…")
  ...
  if qData[1373].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1373].goal.getItem) then
  ...
  if qData[1374].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1374].goal.getItem) and __QUEST_CHECK_ITEMS(qt[1374].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
        NPC_SAY("辛苦了。现在试试看吧。")
  ...
  if qData[1375].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1375].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1376].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1376].goal.getItem) then
      NPC_SAY("辛苦了。下面是…。")
  ...
  if qData[1377].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1377].goal.getItem) then
      NPC_SAY("辛苦了。稍微在努力就…")
  ...
  if qData[1378].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1378].goal.getItem) then
  ...
  if qData[1382].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1382].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1383].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1383].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(1) then
  ...
  if qData[1384].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1384].goal.getItem) then
  ...
  if qData[1385].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1385].goal.getItem) then
  ...
  if qData[1389].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1389].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[867].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[867].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(4) then
