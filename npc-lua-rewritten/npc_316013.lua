...
function npcsay(id)
  ...
  if qData[2379].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2379].goal.getItem) then
  ...
  if qData[2420].state == 1 and __QUEST_CHECK_ITEMS(qt[2420].goal.getItem) then
    if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[2421].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2421].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[2423].state == 1 and __QUEST_CHECK_ITEMS(qt[2423].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2423].goal.getItem) then
    if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[2425].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2425].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2425].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[2442].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2442].goal.getItem) then
  ...
  if qData[2443].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2443].goal.getItem) then
  ...
  if qData[2444].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2444].goal.getItem) then
  ...
  if qData[2452].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2452].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2452].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2452].goal.getItem) then
  ...
  if qData[2453].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2453].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2453].goal.getItem) then
  ...
  if qData[2454].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2454].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2454].goal.getItem) then
  ...
  if qData[3664].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[3664].goal.getItem) then
      NPC_SAY("Ğ»Ğ»£¡")
  ...
  if qData[3665].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[3665].goal.getItem) then
      NPC_SAY("Ğ»Ğ»£¡")
