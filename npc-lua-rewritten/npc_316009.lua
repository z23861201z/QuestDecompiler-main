...
function npcsay(id)
  ...
  if qData[485].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[485].goal.getItem) then
  ...
  if qData[485].state == 2 and qData[486].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[486].goal.getItem) then
  ...
  if qData[486].state == 2 and qData[487].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[487].goal.getItem) then
      NPC_QSAY(487, 1)
  ...
  if qData[490].state == 2 and qData[491].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[491].goal.getItem) then
  ...
  if qData[491].state == 2 and qData[492].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[492].goal.getItem) then
  ...
  if qData[492].state == 2 and qData[2161].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2161].goal.getItem) then
  ...
  if qData[497].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[497].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(4) then
  ...
  if qData[714].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[714].goal.getItem) and __QUEST_CHECK_ITEMS(qt[714].goal.getItem) and __QUEST_CHECK_ITEMS(qt[714].goal.getItem) then
  ...
  if qData[720].state == 1 and __QUEST_CHECK_ITEMS(qt[720].goal.getItem) then
    NPC_SAY("秋叨鱼找到了吗？咳咳。嗯？这个符咒是什么？")
    SET_QUEST_STATE(720, 2)
    return
  end
  if qData[721].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[721].goal.getItem) then
  ...
  if qData[722].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[722].goal.getItem) then
  ...
  if qData[1010].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1010].goal.getItem) then
  ...
  if qData[2130].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2130].goal.getItem) then
