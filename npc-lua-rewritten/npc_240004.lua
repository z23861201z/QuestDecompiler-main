...
function npcsay(id)
  ...
  if qData[1479].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1479].goal.getItem) then
  ...
  if qData[2184].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2184].goal.getItem) then
  ...
  if qData[2588].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2588].goal.getItem) then
  ...
  if qData[2590].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2590].goal.getItem) then
  ...
  if qData[2598].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2598].goal.getItem) then
  ...
  if qData[3647].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[3647].goal.getItem) then
  ...
  if qData[2863].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2863].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(4) then
  ...
  if qData[2869].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2869].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2869].goal.getItem) then
  ...
  if qData[2871].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2871].goal.getItem) then
      NPC_SAY("知道下一步该做什么了吧？")
  ...
  if qData[2872].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2872].goal.getItem) then
      NPC_SAY("不错啊。比我想的快多了。")
  ...
  if qData[2873].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2873].goal.getItem) then
  ...
  if qData[2877].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2877].goal.getItem) then
  ...
  if qData[2878].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2878].goal.getItem) then
  ...
  if qData[2881].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2881].goal.getItem) then
      NPC_SAY("都第二次了，快点吧。")
