...
function npcsay(id)
  ...
  if qData[121].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[121].goal.getItem) and __QUEST_CHECK_ITEMS(qt[121].goal.getItem) then
  ...
  if qData[126].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[126].goal.getItem) and __QUEST_CHECK_ITEMS(qt[126].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(4) then
  ...
  if qData[1257].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1257].goal.getItem) then
  ...
  if qData[1258].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1258].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1259].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1259].goal.getItem) then
  ...
  if qData[1260].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1260].goal.getItem) and __QUEST_CHECK_ITEMS(qt[1260].goal.getItem) then
  ...
  if qData[1261].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1261].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
        NPC_SAY("谢谢。这都是托少侠的福。")
