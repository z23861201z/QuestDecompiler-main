...
function npcsay(id)
  ...
  if qData[93].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[93].goal.getItem) then
  ...
  if qData[450].state == 1 and qData[450].meetNpc[1] == qt[450].goal.meetNpc[1] then
    if __QUEST_CHECK_ITEMS(qt[450].goal.getItem) then
  ...
  if qData[1086].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1086].goal.getItem) then
  ...
  if qData[1094].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1094].goal.getItem) then
      if CHECK_INVENTORY_CNT(3) > 0 then
  ...
  if qData[1218].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1218].goal.getItem) then
...
function chkQState(id)
  ...
  if qData[1218].state == 1 and __QUEST_CHECK_ITEMS(qt[1218].goal.getItem) then
  ...
  if qData[450].state == 1 and GET_PLAYER_LEVEL() >= qt[450].needLevel then
    if qData[450].meetNpc[1] == qt[450].goal.meetNpc[1] and __QUEST_CHECK_ITEMS(qt[450].goal.getItem) then
      QSTATE(id, 2)
    else
      QSTATE(id, 1)
    end
