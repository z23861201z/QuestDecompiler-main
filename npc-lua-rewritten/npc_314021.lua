...
function npcsay(id)
  ...
  clickNPCid = id
  if qData[113].state == 1 and __QUEST_CHECK_ITEMS(qt[113].goal.getItem) then
    NPC_SAY("吸收了无尽的土地精气的李无极的精气。可以好好地祭祀的。现在准备创建门派吧。准备好了吗？")
    SET_QUEST_STATE(113, 2)
    return
  end
  if qData[118].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[118].goal.getItem) and __QUEST_CHECK_ITEMS(qt[118].goal.getItem) then
  ...
  if qData[119].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[119].goal.getItem) and __QUEST_CHECK_ITEMS(qt[119].goal.getItem) then
      NPC_SAY("你的义举为我们正派树立了形象。按照约定，我来教你{0xFFFFFF00}[ 飞龙掌 ]{END}。")
  ...
  if qData[120].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[120].goal.getItem) and __QUEST_CHECK_ITEMS(qt[120].goal.getItem) then
      NPC_SAY("你的义举为我们正派树立了形象。按照约定，我来教你{0xFFFFFF00}[ 飞龙掌 ]{END}。")
  ...
  if qData[381].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[381].goal.getItem) and __QUEST_CHECK_ITEMS(qt[381].goal.getItem) then
      NPC_SAY("你的义举为我们正派树立了形象。按照约定，我来教你{0xFFFFFF00}[ 飞龙掌 ]{END}。")
  ...
  if qData[627].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[627].goal.getItem) and __QUEST_CHECK_ITEMS(qt[627].goal.getItem) then
      NPC_SAY("你的义举为我们正派树立了形象。按照约定，我来教你{0xFFFFFF00}[ 飞龙掌 ]{END}。")
  ...
  if qData[2083].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2083].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2083].goal.getItem) then
      NPC_SAY("你的义举为我们正派树立了形象。按照约定，我来教你{0xFFFFFF00}[ 飞龙掌 ]{END}。")
  ...
  if qData[60].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[60].goal.getItem) then
  ...
  if qData[167].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[167].goal.getItem) then
  ...
  if qData[173].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[173].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
        NPC_SAY("你具备了击退怪物的能力。很好。那么我们正式进行考验吧。")
  ...
  if qData[179].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[179].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
  ...
  if qData[383].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[383].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
  ...
  if qData[633].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[633].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
  ...
  if qData[634].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[634].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
  ...
  if qData[2090].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2090].goal.getItem) then
      if 1 < CHECK_INVENTORY_CNT(2) then
  ...
  if qData[1127].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1127].goal.getItem) then
  ...
  if qData[1128].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1128].goal.getItem) then
  ...
  if qData[1146].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1146].goal.getItem) then
  ...
  if qData[1178].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1178].goal.getItem) then
  ...
  if qData[1399].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1399].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
        NPC_SAY("? ?? ????. ?? ? ?? ???! ???? ?5?? ?? ??? ???? 1?? ??? ??????.")
  ...
  if GET_PLAYER_FACTION() == 0 then
    ...
    elseif GET_PLAYER_JOB1() == 11 then
      ...
      if qData[2091].state ~= 2 and qData[2090].state == 2 and GET_PLAYER_LEVEL() >= qt[2091].needLevel then
        if qData[2091].state == 1 then
          if __QUEST_CHECK_ITEMS(qt[2091].goal.getItem) then
            QSTATE(id, 2)
          else
            QSTATE(id, 1)
          end
