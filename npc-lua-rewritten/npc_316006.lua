...
function npcsay(id)
  ...
  if qData[1560].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1560].goal.getItem) then
  ...
  if qData[284].state == 1 and qData[286].state == 1 then
    if qData[286].killMonster[qt[286].goal.killMonster[1].id] >= qt[286].goal.killMonster[1].count then
      if __QUEST_CHECK_ITEMS(qt[286].goal.getItem) then
  ...
  if qData[284].state == 1 and qData[290].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[290].goal.getItem) then
  ...
  if qData[288].state == 1 then
    if qData[288].killMonster[qt[288].goal.killMonster[1].id] >= qt[288].goal.killMonster[1].count and __QUEST_CHECK_ITEMS(qt[288].goal.getItem) then
  ...
  if qData[483].state == 1 then
    if qData[483].meetNpc[1] == qt[483].goal.meetNpc[1] and qData[483].meetNpc[2] == qt[483].goal.meetNpc[2] then
      if qData[483].meetNpc[3] ~= id and __QUEST_CHECK_ITEMS(qt[483].goal.getItem) then
