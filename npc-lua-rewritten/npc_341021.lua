...
function npcsay(id)
  ...
  if qData[2722].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2722].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2722].goal.getItem) then
  ...
  if qData[3735].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[3735].goal.getItem) then
  ...
  if qData[3786].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[3786].goal.getItem) then
