...
function npcsay(id)
  ...
  if qData[2126].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2126].goal.getItem) then
      NPC_SAY("啊，真的很美.")
  ...
  if qData[2127].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2127].goal.getItem) then
      NPC_SAY("谢谢.")
  ...
  if qData[2128].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2128].goal.getItem) then
  ...
  if qData[2135].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2135].goal.getItem) then
      NPC_SAY("非常感谢。啊啾！")
