...
function npcsay(id)
  ...
  if qData[2674].state == 1 and __QUEST_CHECK_ITEMS(qt[2674].goal.getItem) then
  ...
  if qData[2710].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2710].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2710].goal.getItem) then
      NPC_SAY("谢谢。")
  ...
  if qData[2711].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2711].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2711].goal.getItem) then
      NPC_SAY("谢谢。")
  ...
  if qData[2730].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2730].goal.getItem) then
  ...
  if qData[2731].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2731].goal.getItem) then
...
function chkQState(id)
  ...
  if qData[2674].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2674].goal.getItem) then
      QSTATE(id, 2)
    else
      QSTATE(id, 1)
    end
