...
function npcsay(id)
  ...
  if qData[2034].state == 1 then
    if qData[2034].killMonster[qt[2034].goal.killMonster[1].id] >= qt[2034].goal.killMonster[1].count and __QUEST_CHECK_ITEMS(qt[2034].goal.getItem) then
  ...
  if qData[2039].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2039].goal.getItem) then
  ...
  if qData[2040].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2040].goal.getItem) then
  ...
  if qData[2041].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2041].goal.getItem) then
  ...
  if qData[2042].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2042].goal.getItem) then
  ...
  if qData[2046].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2046].goal.getItem) then
  ...
  if qData[2047].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2047].goal.getItem) then
  ...
  if qData[2048].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2048].goal.getItem) then
  ...
  if qData[2049].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2049].goal.getItem) then
  ...
  if qData[2055].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2055].goal.getItem) then
  ...
  if qData[2061].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2061].goal.getItem) then
  ...
  if qData[2062].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2062].goal.getItem) then
  ...
  if qData[2063].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2063].goal.getItem) then
  ...
  if qData[2071].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2071].goal.getItem) then
  ...
  if qData[2072].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2072].goal.getItem) then
  ...
  if qData[2156].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2156].goal.getItem) then
  ...
  if qData[2157].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2157].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
        NPC_SAY("太感谢了！托你的福，我们佣兵团的名誉挽回了不少。这是答应给你的{0xFFFFFF00}[佣兵团箱子]{END}。请好好使用吧")
  ...
  if qData[2158].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2158].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
        NPC_SAY("太感谢了！托你的福，我们佣兵团的名誉挽回了不少。这是答应给你的{0xFFFFFF00}[佣兵团箱子]{END}。请好好使用吧")
