...
function npcsay(id)
  ...
  if qData[202].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[202].goal.getItem) then
  ...
  if qData[246].state == 1 then
    if qData[246].meetNpc[1] ~= id then
      ...
      return
    elseif __QUEST_CHECK_ITEMS(qt[246].goal.getItem) and __QUEST_CHECK_ITEMS(qt[246].goal.getItem) and __QUEST_CHECK_ITEMS(qt[246].goal.getItem) and __QUEST_CHECK_ITEMS(qt[246].goal.getItem) then
  ...
  if qData[277].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[277].goal.getItem) then
  ...
  if qData[282].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[282].goal.getItem) then
  ...
  if qData[464].state == 1 and qData[463].state == 2 then
    if __QUEST_CHECK_ITEMS(qt[464].goal.getItem) then
      NPC_QSAY(464, 3)
  ...
  if qData[465].state == 1 and qData[464].state == 2 then
    if __QUEST_CHECK_ITEMS(qt[465].goal.getItem) and __QUEST_CHECK_ITEMS(qt[465].goal.getItem) then
      NPC_QSAY(465, 3)
  ...
  if qData[466].state == 1 and qData[465].state == 2 then
    if __QUEST_CHECK_ITEMS(qt[466].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
        NPC_QSAY(466, 3)
  ...
  if qData[1219].state == 1 and __QUEST_CHECK_ITEMS(qt[1219].goal.getItem) then
  ...
  if qData[1220].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1220].goal.getItem) then
  ...
  if qData[1227].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1227].goal.getItem) then
  ...
  if qData[1319].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1319].goal.getItem) then
  ...
  if qData[1320].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1320].goal.getItem) then
  ...
  if qData[1321].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1321].goal.getItem) then
      if CHECK_INVENTORY_CNT(1) > 0 then
        NPC_SAY("辛苦了。下面是…。")
  ...
  if qData[1322].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1322].goal.getItem) then
      NPC_SAY("现在应该是准备就绪了。")
...
function chkQState(id)
  ...
  if qData[1219].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1219].goal.getItem) then
      QSTATE(id, 2)
    else
      QSTATE(id, 1)
    end
