...
function npcsay(id)
  ...
  if qData[2679].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2679].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2679].goal.getItem) then
  ...
  if qData[2799].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2799].goal.getItem) then
...
function chkQState(id)
  ...
  if qData[2793].state == 1 and __QUEST_CHECK_ITEMS(qt[2793].goal.getItem) then
    QSTATE(id, 2)
  end
