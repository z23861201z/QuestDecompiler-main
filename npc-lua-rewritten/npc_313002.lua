...
function npcsay(id)
  ...
  if qData[76].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[76].goal.getItem) then
  ...
  if qData[106].state == 1 then
    if qData[106].meetNpc[1] == qt[106].goal.meetNpc[1] then
      if __QUEST_CHECK_ITEMS(qt[106].goal.getItem) then
  ...
  if qData[198].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[198].goal.getItem) then
  ...
  if qData[200].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[200].goal.getItem) then
  ...
  if qData[1214].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1214].goal.getItem) then
  ...
  if qData[1415].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1415].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
