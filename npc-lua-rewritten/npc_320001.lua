...
function npcsay(id)
  ...
  if qData[1016].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1016].goal.getItem) then
  ...
  if qData[1017].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1017].goal.getItem) then
      NPC_SAY("谢谢。我该怎么报答呢？")
  ...
  if qData[1018].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1018].goal.getItem) then
  ...
  if qData[2467].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2467].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[2566].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2566].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2566].goal.getItem) then
      NPC_SAY("我来看看..都对了")
  ...
  if qData[2567].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2567].goal.getItem) then
      NPC_SAY("我来看看..都对了")
  ...
  if qData[2568].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2568].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2568].goal.getItem) then
