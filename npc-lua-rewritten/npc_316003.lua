...
function npcsay(id)
  ...
  if qData[1542].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1542].goal.getItem) and __QUEST_CHECK_ITEMS(qt[1542].goal.getItem) then
  ...
  if qData[1552].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1552].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1548].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1548].goal.getItem) then
  ...
  if qData[288].state == 2 and qData[284].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[284].goal.getItem) then
  ...
  if qData[284].state == 2 and qData[285].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[285].goal.getItem) then
