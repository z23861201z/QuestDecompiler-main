...
function npcsay(id)
  ...
  if qData[1006].state == 1 and __QUEST_CHECK_ITEMS(qt[1006].goal.getItem) then
  ...
  if qData[1230].state == 1 and __QUEST_CHECK_ITEMS(qt[1230].goal.getItem) then
...
function chkQState(id)
  ...
  if qData[1006].state ~= 2 and qData[1005].state == 2 then
    if qData[1006].state == 1 then
      if __QUEST_CHECK_ITEMS(qt[1006].goal.getItem) then
        QSTATE(id, 2)
      else
        QSTATE(id, 1)
      end
