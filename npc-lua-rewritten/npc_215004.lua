...
function npcsay(id)
  ...
  if qData[160].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[160].goal.getItem) then
      NPC_SAY("????! ?? ??????. ???? ???? ?? ????? ??…. ???. ????. ??? ??? ???? ?, ?? ????~")
  ...
  if qData[164].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[164].goal.getItem) then
  ...
  if qData[276].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[276].goal.getItem) and __QUEST_CHECK_ITEMS(qt[276].goal.getItem) and __QUEST_CHECK_ITEMS(qt[276].goal.getItem) and __QUEST_CHECK_ITEMS(qt[276].goal.getItem) then
      NPC_SAY("?? ??? ? ?? ??? ? ??? ????.")
  ...
  if qData[451].state == 1 and qData[451].meetNpc[1] == qt[451].goal.meetNpc[1] then
    if __QUEST_CHECK_ITEMS(qt[451].goal.getItem) then
  ...
  if qData[556].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[556].goal.getItem) then
      NPC_SAY("??? ?? ???? ????, ?? ??????.")
  ...
  if qData[1283].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1283].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
  ...
  if qData[1306].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1306].goal.getItem) then
  ...
  if qData[1307].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1307].goal.getItem) then
  ...
  if qData[1308].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1308].goal.getItem) then
  ...
  if qData[1309].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1309].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1310].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1310].goal.getItem) and __QUEST_CHECK_ITEMS(qt[1310].goal.getItem) and __QUEST_CHECK_ITEMS(qt[1310].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1311].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1311].goal.getItem) then
  ...
  if qData[1312].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1312].goal.getItem) then
