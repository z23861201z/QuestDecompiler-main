...
function npcsay(id)
  ...
  if qData[163].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[163].goal.getItem) then
  ...
  if qData[1279].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1279].goal.getItem) then
  ...
  if qData[1299].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1299].goal.getItem) then
  ...
  if qData[1300].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1300].goal.getItem) then
  ...
  if qData[1314].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1314].goal.getItem) and __QUEST_CHECK_ITEMS(qt[1314].goal.getItem) and __QUEST_CHECK_ITEMS(qt[1314].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(1) then
