...
function npcsay(id)
  ...
  if qData[2698].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2698].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2698].goal.getItem) then
  ...
  if qData[2699].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2699].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2699].goal.getItem) then
      NPC_SAY("巨木神很满足。")
  ...
  if qData[2700].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2700].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2700].goal.getItem) then
      NPC_SAY("巨木神很满意。")
  ...
  if qData[2701].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2701].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2701].goal.getItem) then
  ...
  if qData[2736].state == 1 and __QUEST_CHECK_ITEMS(qt[2736].goal.getItem) and qData[2736].killMonster[qt[2736].goal.killMonster[1].id] >= qt[2736].goal.killMonster[1].count then
    NPC_SAY("巨木神好奇。找到{0xFFFFFF00}獐子潭{END}了吗？哦，这是{0xFFFFFF00}水晶碎片{END}啊。")
    SET_QUEST_STATE(2736, 2)
    return
  end
  if qData[2737].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2737].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2737].goal.getItem) then
      NPC_SAY("巨木神称赞，辛苦了。")
