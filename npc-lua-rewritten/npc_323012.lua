...
function npcsay(id)
  ...
  if qData[2183].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2183].goal.getItem) then
      NPC_SAY("谢谢啊~")
  ...
  if qData[2589].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2589].goal.getItem) then
  ...
  if qData[2595].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2595].goal.getItem) then
  ...
  if qData[3646].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[3646].goal.getItem) then
