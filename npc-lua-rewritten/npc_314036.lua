...
function npcsay(id)
  ...
  if qData[2119].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2119].goal.getItem) then
      NPC_SAY("辛苦了。我要烤着吃")
  ...
  if qData[2120].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2120].goal.getItem) then
      NPC_SAY("辛苦了。这次我要煮着吃")
  ...
  if qData[2121].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2121].goal.getItem) then
  ...
  if qData[2134].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2134].goal.getItem) then
      NPC_SAY("辛苦了.")
