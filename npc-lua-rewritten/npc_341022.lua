...
function npcsay(id)
  ...
  if qData[2906].state == 1 and __QUEST_CHECK_ITEMS(qt[2906].goal.getItem) then
  ...
  if qData[3733].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[3733].goal.getItem) then
  ...
  if qData[3784].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[3784].goal.getItem) then
      NPC_SAY("这么快！太感谢了~")
