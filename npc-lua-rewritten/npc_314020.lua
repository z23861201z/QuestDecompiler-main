...
function npcsay(id)
  ...
  clickNPCid = id
  if qData[112].state == 1 and __QUEST_CHECK_ITEMS(qt[112].goal.getItem) then
    NPC_SAY("是饱含大地之力的李无极的精气啊。这下可以好好的祭祀了。现在试着创建门派吧。准备好了吗？")
    SET_QUEST_STATE(112, 2)
    return
  end
  if qData[123].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[123].goal.getItem) and __QUEST_CHECK_ITEMS(qt[123].goal.getItem) then
  ...
  if qData[124].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[124].goal.getItem) and __QUEST_CHECK_ITEMS(qt[124].goal.getItem) then
      NPC_SAY("你很好的掌控了弱者内心的愤怒。按照约定，我来教你飞龙掌。")
  ...
  if qData[125].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[125].goal.getItem) and __QUEST_CHECK_ITEMS(qt[125].goal.getItem) then
      NPC_SAY("你很好的掌控了弱者内心的愤怒。按照约定，我来教你飞龙掌。")
  ...
  if qData[382].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[382].goal.getItem) and __QUEST_CHECK_ITEMS(qt[382].goal.getItem) then
      NPC_SAY("你很好的掌控了弱者内心的愤怒。按照约定，我来教你飞龙掌。")
  ...
  if qData[631].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[631].goal.getItem) and __QUEST_CHECK_ITEMS(qt[631].goal.getItem) then
      NPC_SAY("你很好的掌控了弱者内心的愤怒。按照约定，我来教你飞龙掌。")
  ...
  if qData[2087].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2087].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2087].goal.getItem) then
  ...
  if qData[64].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[64].goal.getItem) then
  ...
  if qData[170].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[170].goal.getItem) then
  ...
  if qData[176].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[176].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
        NPC_SAY("你具备了击退怪物的能力。很好。那么我们正式进行考验吧。")
  ...
  if qData[182].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[182].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
  ...
  if qData[386].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[386].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
  ...
  if qData[636].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[636].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
  ...
  if qData[637].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[637].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
  ...
  if qData[2093].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2093].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(2) then
        NPC_SAY("你通过了第一次考验。但这仅仅是考验的开始。")
  ...
  if qData[1124].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1124].goal.getItem) then
  ...
  if qData[1125].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1125].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
        NPC_SAY("实力不错啊。我认可了。")
  ...
  if qData[1147].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1147].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1177].state == 1 and __QUEST_CHECK_ITEMS(qt[1177].goal.getItem) then
    if 1 <= CHECK_INVENTORY_CNT(3) then
  ...
  if qData[1179].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1179].goal.getItem) then
  ...
  if qData[1404].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1404].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(3) then
        NPC_SAY("????. ??? ??  ????? 5?? ???? ???? 1?? ?? ? ???, ??? ??? ?? ???? ???.")
...
function chkQState(id)
  ...
  if GET_PLAYER_FACTION() == 1 then
    ...
    elseif GET_PLAYER_JOB1() == 5 then
      ...
      if qData[2094].state ~= 2 and qData[2093].state == 2 and GET_PLAYER_LEVEL() >= qt[2094].needLevel then
        if qData[2094].state == 1 then
          if __QUEST_CHECK_ITEMS(qt[2094].goal.getItem) then
            QSTATE(id, 2)
          else
            QSTATE(id, 1)
          end
  ...
  if qData[1175].state == 2 and qData[1177].state ~= 2 and qData[1177].state == 1 and __QUEST_CHECK_ITEMS(qt[1177].goal.getItem) then
    QSTATE(id, 1)
  end
