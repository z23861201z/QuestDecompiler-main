...
function npcsay(id)
  ...
  if qData[1557].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1557].goal.getItem) and __QUEST_CHECK_ITEMS(qt[1557].goal.getItem) and qData[1557].killMonster[qt[1557].goal.killMonster[1].id] >= qt[1557].goal.killMonster[1].count then
