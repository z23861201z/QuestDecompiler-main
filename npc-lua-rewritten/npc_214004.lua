...
function npcsay(id)
  ...
  if qData[1085].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1085].goal.getItem) then
  ...
  if qData[1093].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1093].goal.getItem) then
      if CHECK_INVENTORY_CNT(3) > 0 then
  ...
  if qData[1118].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1118].goal.getItem) then
  ...
  if qData[1136].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1136].goal.getItem) then
