...
function npcsay(id)
  ...
  if qData[1141].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1141].goal.getItem) and __QUEST_CHECK_ITEMS(qt[1141].goal.getItem) and __QUEST_CHECK_ITEMS(qt[1141].goal.getItem) and __QUEST_CHECK_ITEMS(qt[1141].goal.getItem) then
  ...
  if qData[2024].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2024].goal.getItem) then
