...
function npcsay(id)
  ...
  if qData[1051].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1051].goal.getItem) then
  ...
  if qData[1057].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1057].goal.getItem) and __QUEST_CHECK_ITEMS(qt[1057].goal.getItem) then
  ...
  if qData[2675].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2675].goal.getItem) and qData[2675].killMonster[qt[2675].goal.killMonster[1].id] >= qt[2675].goal.killMonster[1].count then
      NPC_SAY("谢谢，太感谢了。")
  ...
  if qData[2676].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2676].goal.getItem) and qData[2676].killMonster[qt[2676].goal.killMonster[1].id] >= qt[2676].goal.killMonster[1].count then
      NPC_SAY("真心感谢！")
