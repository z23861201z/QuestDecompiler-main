...
function npcsay(id)
  ...
  if qData[2735].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2735].goal.getItem) then
  ...
  if qData[2790].state == 1 and __QUEST_CHECK_ITEMS(qt[2790].goal.getItem) then
  ...
  if qData[2830].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2830].goal.getItem) then
      NPC_SAY("这么快！果然很厉害。")
  ...
  if qData[2831].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2831].goal.getItem) then
