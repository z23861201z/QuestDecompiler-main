...
function npcsay(id)
  ...
  if qData[1055].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[1055].goal.getItem) then
  ...
  if qData[2714].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2714].goal.getItem) and __QUEST_CHECK_ITEMS(qt[2714].goal.getItem) then
      NPC_SAY("哈哈，谢谢！")
  ...
  if qData[2800].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2800].goal.getItem) then
  ...
  if qData[2801].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2801].goal.getItem) then
      NPC_SAY("厉..厉害。")
  ...
  if qData[2802].state == 1 then
    if __QUEST_CHECK_ITEMS(qt[2802].goal.getItem) then
