...
function npcsay(id)
  ...
  if qData[724].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[724].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[724].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[724].goal.getItem) then
  ...
  if qData[2190].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2190].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2190].goal.getItem) then
  ...
  if qData[2210].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2210].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2210].goal.getItem) then
  ...
  if qData[2211].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2211].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2211].goal.getItem) then
  ...
  if qData[2213].state == 1 then
    if qData[2213].killMonster[qt[2213].goal.killMonster[1].id] >= qt[2213].goal.killMonster[1].count and __QUEST_HAS_ALL_ITEMS(qt[2213].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2213].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2213].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2213].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2213].goal.getItem) then
  ...
  if qData[2324].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2324].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2324].goal.getItem) then
