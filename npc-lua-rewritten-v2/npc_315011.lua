...
function npcsay(id)
  ...
  if qData[121].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[121].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[121].goal.getItem) then
  ...
  if qData[126].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[126].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[126].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(4) then
  ...
  if qData[1260].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[1260].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[1260].goal.getItem) then
