...
function npcsay(id)
  ...
  if qData[132].state == 1 then
    if qData[132].meetNpc[1] ~= id then
      ...
      NPC_QSAY(132, 1)
      return
    elseif __QUEST_HAS_ALL_ITEMS(qt[132].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[132].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[132].goal.getItem) then
  ...
  if qData[429].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[429].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[429].goal.getItem) then
  ...
  if qData[430].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[430].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[430].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(1) then
        NPC_SAY("?????. ?????. ? ???? ?? ???.")
  ...
  if qData[431].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[431].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[431].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(1) then
        NPC_SAY("?????. ?????. ? ???? ?? ???.")
  ...
  if qData[432].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[432].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[432].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(1) then
        NPC_SAY("?????. ?????. ? ???? ?? ???.")
  ...
  if qData[687].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[687].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[687].goal.getItem) then
      if 1 <= CHECK_INVENTORY_CNT(1) then
        NPC_SAY("?????. ?????. ? ???? ?? ???.")
  ...
  if qData[447].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[447].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[447].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[447].goal.getItem) then
