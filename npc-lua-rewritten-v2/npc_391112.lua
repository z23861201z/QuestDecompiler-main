...
function npcsay(id)
  ...
  if qData[2698].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2698].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2698].goal.getItem) then
  ...
  if qData[2699].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2699].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2699].goal.getItem) then
      NPC_SAY("巨木神很满足。")
  ...
  if qData[2700].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2700].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2700].goal.getItem) then
      NPC_SAY("巨木神很满意。")
  ...
  if qData[2701].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2701].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2701].goal.getItem) then
  ...
  if qData[2737].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2737].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2737].goal.getItem) then
      NPC_SAY("巨木神称赞，辛苦了。")
