...
function npcsay(id)
  ...
  if qData[2710].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2710].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2710].goal.getItem) then
      NPC_SAY("谢谢。")
  ...
  if qData[2711].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2711].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2711].goal.getItem) then
      NPC_SAY("谢谢。")
