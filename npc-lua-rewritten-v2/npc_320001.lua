...
function npcsay(id)
  ...
  if qData[2566].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2566].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2566].goal.getItem) then
      NPC_SAY("我来看看..都对了")
  ...
  if qData[2568].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[2568].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[2568].goal.getItem) then
