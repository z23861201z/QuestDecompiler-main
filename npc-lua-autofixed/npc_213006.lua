function npcsay(id)
  ...
  if qData[132].state == 1 then
    if qData[132].meetNpc[1] ~= id then
      ...
      NPC_QSAY(132, 1)
      return
    elseif __QUEST_HAS_ALL_ITEMS(qt[132].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[132].goal.getItem) then
  ...
  if qData[447].state == 1 then
    if __QUEST_HAS_ALL_ITEMS(qt[447].goal.getItem) and __QUEST_HAS_ALL_ITEMS(qt[447].goal.getItem) then
